...
class CustomNumberCounter extends StatefulWidget {
  ...
  @override
  _CustomNumberCounterState createState() => _CustomNumberCounterState();
}
...
class _CountupAnimatedText extends AnimatedWidget {
  ...
  Widget build(BuildContext context) => Text(
        separator != null
            ? '$prefix${animation.value.toStringAsFixed(precision).replaceAllMapped(reg, (Match match) => '${match[1]} ')}$suffix'
